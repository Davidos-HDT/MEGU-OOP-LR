...
namespace OOPLR6
{
    public partial class Form1 : Form
    {
        ...
        {
            pmail_zm = new pmail("Бананщіку", 4, 7, 50); pmail_zm.info();
            pmail_zm++; pmail_zm.info();
            ++pmail_zm; pmail_zm.info();
        }
        ...
        {
            pmail_zm = new pmail("Бананщіку", 4, 7, 50); pmail_zm.info();
            email_zm = new email("Бананщіку", 4, 7, 50, 1); email_zm.info();
            if (pmail_zm == email_zm)
                MessageBox.Show("Листи рівні");
            else
                MessageBox.Show("Листи не рівні");
        }
    }
    ...
    public class pmail : mail
    {
        ...
        public static bool operator ==(pmail pmail_zm, email email_zm)
        {
            return pmail_zm.min() == email_zm.min() && pmail_zm.max() == email_zm.max() && pmail_zm.perimeter() == email_zm.perimeter();
        }

        public static bool operator !=(pmail pmail_zm, email email_zm)
        {
            return !(pmail_zm == email_zm);
        }

        public static pmail operator ++(pmail pmail_zm)
        {
            return new pmail(pmail_zm.komy, pmail_zm.width + 15, pmail_zm.height + 10, pmail_zm.symbol + 5);
        }
